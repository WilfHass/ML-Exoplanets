...
parser.add_argument('--output', default="TorchTensors", type=str, help="path to TorchTensors directory")
args = parser.parse_args()

input_loc = str(args.input)
output_loc = str(args.output)

filename_in = args.input + "/train-00008-of-00008"
filename_out = args.output + "/train-00008-of-00008"
...
for parsed_record in parsed_dataset.take(num_samples):
    ...
    array.append(local_list + global_list + [label])
